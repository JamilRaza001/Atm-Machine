...
if (EnterPin.pin === PinCode) {
  ...
  if (options.option === "Fastcash") {
    ...
    if (FastCash.fastCash === 1000) {
      console.log(
        chalk.yellow("Your Account Balance:"),
        chalk.blue.bold((AccountBalance -= FastCash.fastCash))
      );
...
if(OtherAmount.otherAmount < AccountBalance){
  console.log(
    chalk.yellow("Your Account Balance:"),
    chalk.blue.bold((AccountBalance -= OtherAmount.otherAmount))
  );
}
  else{
    console.log(chalk.red.bold("Insufficient Funds"));
    ...
    console.log(
      chalk.yellow("Your Account Balance:"),
      chalk.blue.bold(AccountBalance)
    );
    ...
    console.log(
      chalk.yellow("Your Account Balance:"),
      chalk.blue.bold((AccountBalance += deposit.Debit))
    );
  } else {
    console.log(
      chalk.yellow("Your Account Balance:"),
      chalk.green.bold(AccountBalance)
    );
  }
} else {
